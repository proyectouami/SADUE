...
public class DialogoReporteVGenerado extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public DialogoReporteVGenerado() {
	...
	//		btnAceptar.setFont(new Font("Myriad Pro", Font.PLAIN, 15));
		...
		JLabel lblCompraFin = new JLabel("Se ha generado el reporte de ventas correctamente");
	...
	//	lblEstsAPunto.setFont(new Font("Myriad Pro", Font.PLAIN, 17));
		...
		lblCompraFin.setBounds(54, 30, 362, 18);
